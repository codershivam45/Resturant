...
document.querySelector(".menu").addEventListener("click", () => {
    console.log("hello");
    if (document.querySelector(".search-links").style.display == "none") {
        document.querySelector(".search-links").style.display = "block";
    } else {
        document.querySelector(".search-links").style.display = "none";
    }
})
...
document.querySelector("input").addEventListener("input",(e)=>{
    ...
    menu.forEach((item) => {
        ...
        if (itemtitle.includes(searchitem)) {
            let card = document.querySelector("card");
            console.log(card);
            foundItems=true;
            let html = `
    ...
    // if(card.innerHTML=""){
    //     card.innerHTML="No such dishes found";
    // }

    if(!foundItems){
        const noItemsFoundHtml = `
        <div class="no-dish-found">
            Dish Not Found 
        </div>
    `;
    card.innerHTML = noItemsFoundHtml;
